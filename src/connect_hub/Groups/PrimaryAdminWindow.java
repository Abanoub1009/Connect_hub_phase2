...
<<<<<<< HEAD
        try {
            ...
            Logger.getLogger(PrimaryAdminWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
         JOptionPane.showMessageDialog(this, "Group deleted succeffully", "Success", JOptionPane.INFORMATION_MESSAGE);
         this.dispose();
         gui window=new gui(email);
         window.setVisible(true);
