 ...
 */
public class GetMemberForMember extends javax.swing.JFrame {
    ...
    public GetMemberForMember(Group g, String email) {
        initComponents();
        this.g = g;
        this.email = email;
        openWindow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GetMemberForMember.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GetMemberForMember().setVisible(true);
            }
        });
    }
