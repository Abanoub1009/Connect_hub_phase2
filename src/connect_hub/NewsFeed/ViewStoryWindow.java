 ...
 */
public class ViewStoryWindow extends javax.swing.JFrame {

    private  Story s;
    public ViewStoryWindow(Story s) {
        initComponents();
        this.s=s;
        updateData(s);
    }
    ...
    public void updateData(Story s){
        jLabel2.setText(s.getCaption());
        jLabel1.setText(s.getTimestamp());
        if (s.getPhoto()!= null) {
        ImageIcon i = resizeImage(s.getPhoto() , jLabel5.getWidth(), jLabel5.getHeight());
         jLabel5.setIcon(i);}
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewStoryWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewStoryWindow().setVisible(true);
            }
        });
    }
